...
Use this map to find the single durable owner for a question.

| Question | Owner |
| --- | --- |
| What does the ordering API do? | [Ordering specification](docs/specs/ordering.md) |
...
| How is a change executed and closed? | [WORKFLOW.md](WORKFLOW.md) |
| What must a contribution contain? | [CONTRIBUTING.md](CONTRIBUTING.md) |
